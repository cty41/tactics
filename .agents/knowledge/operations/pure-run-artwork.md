...
timestamp: "2026-08-25T01:03:18+08:00"
status: active
...
source_fingerprint: sha256:17c5df004f02013174aaeae2594c6df9b56b7979ee7f2c53f4ed2cf8417dd55a
---
...
- Pure Run 装备图已形成独立的扁平风格门禁：合同可绑定 `styleSpec`、目标可见高度与容差，`prepare-equipment-candidate` 以真实 Alpha 边界执行等比缩放、基线定位、有限色阶处理并记录内部色阶与连续渐变指标；自动报告只负责技术防漂移，仍须逐图获得 `cty41` 人工确认才能晋升。当前正式装备包含亚马逊长矛/圆盾、法师橡木杖、死灵匕首、魔剑士绑定剑、普通铁剑，以及已完成本轮风格收敛的皮甲 V04、铁头盔 V04、皮靴 V05、暗影斗篷 V04 与法师帽 V04。项目自有失败候选、尺寸对照和透明修复稿作为 `supporting-derived` 审计证据保留，不得充当正式母图；第三方截图只用于本地视觉参考，不进入公开仓库或项目自有 provenance。
