...
| 状态 | 缺口与证据 | 未激活原因 | 激活条件 | 历史来源 |
|---|---|---|---|---|
| `deferred` | [魔剑士职业设计](demonbound-class-design.md)的非大师内容、腐化/冥想、附身 AI、Run/Resource/Workbench 与自动测试已进入实现；三个大师技能、正式角色美术、完整 VFX 和音频仍未设计或制作。 | 当前活跃计划明确排除大师技能与正式表现资产。 | 分别确认大师技能规则或正式美术/表现资源预算，再建立独立计划。 | 2026-08-18 魔剑士实现循环 |
