...
- [x] Phase 4 Pure Run Unit 已收口：12 Unit、19 个项目自有 PNG、共享 Actor、13 项 Catalog、Gallery/Spawn、四向/死亡/Shadow/Goat tint 与原生 1600×900 布局通过自动及 canonical Editor 人工验收，batch 达到 `Validated/UnityOwned`。
- [x] Phase 4 完成计划已从 active plan 目录删除，由 Git 历史保留；该晋升只覆盖已迁移的项目自有 Unit 视觉，不扩大到 deferred/第三方依赖或后续类别。
