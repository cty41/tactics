        ...
        private SkillGraphNode CreateNodeView(SkillGraphNodeRecord record)
        {
            SkillGraphNode nodeView = record switch
            {
                ...
                ApplyDamageNodeRecord r => new SkillGraphNode(r.NodeId,
                    ...
                    info: $"Dmg: {r.BaseDamage}, Type: {r.DamageType}, Element: {r.ElementType}" +
                          (r.AccuracyPenalty > 0 ? $", AccPenalty: {r.AccuracyPenalty}" : "")),
                ...
                NecromancerSkillNodeRecord r => new SkillGraphNode(r.NodeId,
