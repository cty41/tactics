...
namespace Tactics.Tbsf.Common.Units
{
    ...
    public interface IUnitManager
    {
        ...
        /// <summary>
        /// Event triggered when a unit is removed from the manager, typically when the unit is destroyed during the game, or removed by calling <see cref="Tactics.Tbsf.Common.Units.IUnit.RemoveFromGame"/>
        /// </summary>
