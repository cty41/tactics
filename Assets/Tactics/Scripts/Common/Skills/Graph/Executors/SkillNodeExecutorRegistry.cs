...
namespace Tactics.Common.Skills.Graph
{
    ...
    public static class SkillNodeExecutorRegistry
    {
        ...
        static SkillNodeExecutorRegistry()
        {
            ...
            Register(new PlayVisualCueNodeExecutor());
            Register(new PlayPresentationCueNodeExecutor());
            ...
            Register(new RemoveHarmfulBuffsNodeExecutor());
            ...
            Register(new NecromancerSkillNodeExecutor());
            Register(new AmazonSkillNodeExecutor());
        }
