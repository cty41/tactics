...
{
    /// <summary>
    /// Unity component for melee attack ability. Range: 1 tile (adjacent only).
    /// </summary>
    public class MeleeAttackAbility : Ability
    {
        private MeleeAttackAbilityImpl _impl;

        public override void Initialize(IGridController gridController)
        {
            base.Initialize(gridController);
            _impl = new MeleeAttackAbilityImpl(UnitReference, this);
