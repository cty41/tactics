...
{
    /// <summary>
    /// Command to execute a melee attack action by a unit on a target unit.
    /// </summary>
    public readonly struct MeleeAttackCommand : ICommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MeleeAttackCommand"/> struct.
        /// </summary>
        /// <param name="target">The unit to be attacked.</param>
        /// <param name="damage">The damage value to be inflicted.</param>
        /// <param name="actionCost">The number of action points consumed.</param>
        public MeleeAttackCommand(IUnit target, float damage, int actionCost = 1)
        {
            _target = target;
            _damage = damage;
        ...
        public ICommand Deserialize(Dictionary<string, object> actionParams, IGridController gridController)
        {
            ...
            return new MeleeAttackCommand(target, damage, actionCost);
        }
    }
}
