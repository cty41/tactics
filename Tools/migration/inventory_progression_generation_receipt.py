...
def main() -> None:
    ...
    owned=[path for path in paths if path.name=="InventoryProgressionCatalog.tres" or path.name=="SummonFireDemonAttack.tres" or path.stem in {
