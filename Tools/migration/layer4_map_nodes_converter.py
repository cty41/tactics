...
def main()->None:
 ...
 draft={'schemaVersion':1,'batchId':BATCH,'source':{'tag':export['sourceTag'],'commit':export['sourceCommit'],'unityVersion':export['unityVersion'],'exportHash':sha(Path(a.export))},'map':{'contentId':'run-map.pure-run.layer4-v1','layoutVersion':2,'nodes':['start','layer_01_battle','layer_02_battle','layer_03_battle','layer_04_battle','layer_04_rest','layer_04_store','layer_04_event'],'layer4':['layer_04_battle','layer_04_rest','layer_04_store','layer_04_event']},'encounter':{'contentId':'encounter.pure-run.n4','layout':'battle-layout.pure-run.split-flank','monsters':['unit.pure-run.ranged','unit.pure-run.ranged','unit.pure-run.aoe','unit.pure-run.charger']},'rest':{'contentId':'rest.pure-run.standard-v1','healPercent':30,'manaPercent':30},'store':{'contentId':'store.pure-run.standard-v1','stockSize':4,'consumableGuarantee':1},'events':events,'excluded':['N5','N6','E1','E2','Special','Treasure','Lv3']}
