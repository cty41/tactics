...
Asset type: production-ready Unity 2D single-frame enemy sprite
Primary request: preserve the approved Pure Run capsule-monster style exactly
...
生成阶段使用均匀纯 `#00ff00` 色幕，去幕后保存 RGBA；角色内部不得使用幕色。
