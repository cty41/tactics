...
Primary request: dead NPC lying on its back flat, head toward upper-right of the screen, short and thick body, four paws still attached in one continuous soft outline; one compact upright capsule-dog villager
...
Pose (this image): prone flat death pose, compact
