...
public class BuffItemBatchGodotTests
{
    ...
    public void BatchAndCanonicalCatalogsValidateWithExternalPoisonOwnership()
    {
        ...
        AssertThat(validation.GlobalCatalogEntryCount is 114 or 115 or 116 or 119 or 123 or 124 or 125 or 131).IsTrue();
    ...
    public void CanonicalCatalogUsesUniqueContentIdsAndRegisteredUids()
    {
        ...
        catalog.Validate();
        AssertThat(catalog.Entries.Length is 114 or 115 or 116 or 119 or 123 or 124 or 125 or 131).IsTrue();
