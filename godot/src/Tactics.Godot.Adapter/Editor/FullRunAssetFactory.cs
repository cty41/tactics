...
public static class FullRunAssetFactory
{
    ...
    public static void Build()
    {
        ...
        if(all.Length is not (114 or 115 or 116 or 119 or 121 or 131 or 141))throw new InvalidOperationException($"Expected a supported full-run aggregate, got {all.Length} entries.");
