...
public static class InventoryProgressionAssetFactory
{
    ...
    public static void Build()
    {
        ...
        if (generated.Count != 27) throw new InvalidOperationException($"Expected 27 new skill resources, got {generated.Count}.");
        ...
        if (global.Entries.Length is not (101 or 108 or 114 or 115 or 116 or 119)) throw new InvalidOperationException($"Canonical Catalog count is invalid: {global.Entries.Length}.");
