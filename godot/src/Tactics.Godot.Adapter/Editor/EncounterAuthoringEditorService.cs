...
public static class EncounterAuthoringEditorService
{
    ...
    public static void Write(BattleLayoutResource value, BattleLayoutAuthoringDocument document)
    {
        ...
        value.PartySpawnsValue = Format(document.PartySpawns); value.EnemySpawnsValue = Format(document.EnemySpawns); value.BlockedCellsValue = Format(document.BlockedCells);
    }
