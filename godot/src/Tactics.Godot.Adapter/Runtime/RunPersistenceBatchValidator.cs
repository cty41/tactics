...
public static class RunPersistenceBatchValidator
{
    public static RunPersistenceBatchValidation Validate(GodotResourceCatalog batch, GodotResourceCatalog global, PackedScene fixtureScene)
    {
        ...
        if (batch.Entries.Length != 1 || global.Entries.Length is not (74 or 101 or 108 or 114 or 115 or 116 or 119 or 123 or 124 or 125 or 131 or 141 or 142 or 143)) throw new InvalidOperationException("Pure Run catalog count is invalid.");
