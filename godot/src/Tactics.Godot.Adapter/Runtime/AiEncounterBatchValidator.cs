...
public static class AiEncounterBatchValidator
{
    ...
    {
        batch.Validate();global.Validate();if(batch.Entries.Length!=15||global.Entries.Length is not (74 or 101 or 108 or 114 or 115 or 116 or 119 or 123 or 124 or 125))throw new InvalidOperationException("AI/Encounter or canonical Catalog count is invalid.");
