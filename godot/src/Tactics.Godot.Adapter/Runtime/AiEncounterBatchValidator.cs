...
public static class AiEncounterBatchValidator
{
    ...
    {
        batch.Validate();global.Validate();if(batch.Entries.Length!=15||global.Entries.Length!=74)throw new InvalidOperationException("AI/Encounter or canonical Catalog count is invalid.");
